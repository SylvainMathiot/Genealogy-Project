...
public class Genealogy extends Application{
	private static final Logger logger = LogManager.getLogger(LoggerSingleton.getInstance().getLoggerName(Genealogy.class));
	...
	public void start(Stage primaryStage) throws Exception {
		...
		primaryStage.getIcons().add(new Image(Genealogy.class.getResourceAsStream("graphic/image/genealogy128.png")));
		...
		scene.getStylesheets().add(Genealogy.class.getResource("graphic/stylesheet.css").toExternalForm());
		...
		ScanningContainer databaseFolderScanning = new ScanningContainer(PropertiesSingleton.getInstance().get("DATABASE.FOLDER"));
